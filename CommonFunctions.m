...
NSMutableArray * generateForbiddenClassesArray(BOOL isRecursive) {
	...
	forbiddenClasses = forbiddenClasses ?: [[NSMutableArray alloc] init];
...
NSMutableArray * generateForbiddenPathsArray(BOOL isRecursive) {
	static NSMutableArray *forbiddenPaths = nil;
	forbiddenPaths = forbiddenPaths ?: [[NSMutableArray alloc] init];
